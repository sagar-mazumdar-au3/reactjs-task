    ...
    <ThemeProvider theme={theme}>
      ...
      <AppBar position="relative">
        <Toolbar >
          ...
          <Typography sx={{ cursor: 'pointer', flexGrow: 1 }} variant="h6" component="div" color="inherit" noWrap onClick={() => { dispatch(showHideCart()) }}>
            Cart
          </Typography>
          {state.isLoggedIn && <Button color="inherit" onClick={() => { dispatch(logout()) }}>Logout</Button>}
        </Toolbar>
      </AppBar>
      <main>
